...
void EpubReaderActivity::render(RenderLock&& lock) {
  ...
  // Change-detection keys on the raw pageCount (monotonic build watermark); the value
  // persisted is estimatedTotalPages(), which degrades to pageCount once finalized.

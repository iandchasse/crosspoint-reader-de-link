  ...
  static const std::vector<SettingInfo> baseList = [] {
    static const SettingInfo array[] = {
        ...
        SettingInfo::Value(StrId::STR_FRONTLIGHT, &CrossPointSettings::frontlightBrightness,
                           SettingInfo::ValueRange{0, 100, 5}, "frontlightBrightness", StrId::STR_NONE_OPT),
        SettingInfo::Value(StrId::STR_FRONTLIGHT, &CrossPointSettings::frontlightWarmth,
                           SettingInfo::ValueRange{0, 100, 5}, "frontlightWarmth", StrId::STR_NONE_OPT),
#endif
        ...
        // Duplicate of the clockFormat12h row above (the two clock stacks each grew
        // their own). Retargeted at clockFormat12h so both rows agree; the extra row
        // and its legacy "clockFormat" key go away when the stacks are merged.
        SettingInfo::Enum(StrId::STR_CLOCK_FORMAT, &CrossPointSettings::clockFormat12h,

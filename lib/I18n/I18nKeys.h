...
enum class StrId : uint16_t {
  ...
  STR_FETCHING_FONTS,
  STR_FONTS_FOUND,
  STR_FONTS_DOWNLOADED,
  STR_DOWNLOAD_TYPE_TITLE,
  STR_DOWNLOAD_TYPE_PRECONVERTED,
  STR_DOWNLOAD_TYPE_TTF,
  STR_DOWNLOAD_TYPE_DISCLAIMER,
  STR_SELECT_FONTS_TITLE,
  STR_DOWNLOAD_START,
  STR_CUSTOM_FONTS,
...
// Order: English, Беларуская, Català, Čeština, Dansk, Deutsch, Español, Suomi, Français, Italiano, Nederlands, Polski, Português (Brasil), Română, Русский, Svenska, Українська
constexpr uint8_t SORTED_LANGUAGE_INDICES[] = {0, 11, 9, 4, 15, 3, 1, 14, 2, 12, 16, 13, 5, 8, 6, 7, 10};
